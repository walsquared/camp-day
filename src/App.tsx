    ...
    <div className='app'>
      ...
      <section className='context'>
        <div>
          ...
          <p>
            You and two companions are invited to enjoy some fun and games while also competing against others for fame!
          </p>
          <p>
            Games will begin at <b>6pm on Saturday, August 26th</b>, at{' '}
            <a href='https://goo.gl/maps/GYYfQoJsXAiobogJA' target='_blank' rel='noopener noreferrer'>
              Parc de Normanville
            </a>
            . The program will be posted here soon!
          </p>
          <p>
            These activities will involve both physical and creative skills. There might also be options for arts and
            crafts.
          </p>
          <p>
            Below you’ll find a registration form — only one person per team will need to register. Please register your
            team by noon on <b>Saturday, August 26th!</b>
          </p>
          <p>
